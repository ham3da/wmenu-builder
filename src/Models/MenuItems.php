...
class MenuItems extends Model
{
    ...
    {
        return $this->belongsTo('Ham3da\Menu\Models\Menus', 'menu');
    }

    public function child()
    {
        return $this->hasMany('Ham3da\Menu\Models\MenuItems', 'parent')->orderBy('sort', 'ASC');
    }
}
